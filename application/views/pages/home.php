...
<div id="slides">
	<ul class="slides-container">
		<li class="slides-item">
			<div class="slides-bg" style="background:url('assets/images/slider2.jpg');" alt=""></div>
		</li>
		
		<li class="slides-item">
			<div class="slides-bg" style="background:url('assets/images/slider1.jpg');" alt=""></div>
		</li>
	</ul>
...
<div class="instagram-section">
	...
	<div class="instagram-slick">
		<div class="instagram-slick-col"> 
			<a href="#">
				<img src="assets/images/insta1.jpg" alt="Instagram" title="Instagram">
			</a>
		</div>
		<div class="instagram-slick-col"> 
			<a href="#">
		...
		<div class="instagram-slick-col"> 
			<a href="#">
				<img src="assets/images/insta2.jpg" alt="Instagram" title="Instagram">
			</a>
		</div>
		<div class="instagram-slick-col"> 
			<a href="">
				<img src="assets/images/insta3.jpg" alt="Instagram" title="Instagram">
			</a>
		</div>
		<div class="instagram-slick-col"> 
			<a href="">
				<img src="assets/images/insta4.jpg" alt="Instagram" title="Instagram">
			</a>
		</div>
		<div class="instagram-slick-col"> 
			<a href="">
				<img src="assets/images/insta5.jpg" alt="Instagram" title="Instagram">
			</a>
		</div>
		<div class="instagram-slick-col"> 
			<a href="">
				<img src="assets/images/insta6.jpg" alt="Instagram" title="Instagram">
			</a>
		</div>
		<div class="instagram-slick-col"> 
			<a href="">
