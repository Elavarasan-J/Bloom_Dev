...
<html>
	<head>
		...
		<link rel="stylesheet" href="<?php echo base_url(); ?>assets/style/responsive.css">
    </head>
   <body>
	   <!-- Wrapper -->
	   <div class="wrapper">		    
				...
				<!-- Brand and toggle get grouped for better mobile display -->
					<div class="navbar-header visible-xs-block">
						...
						<a class="navbar-brand" href="index.php">
							<img class="logo-black" src="<?php echo base_url(); ?>assets/images/logo-black.png" alt="Bloom">
						</a>
					</div>
					...
					<div class="collapse navbar-collapse" id="mobile-menu">
						<ul class="nav navbar-nav custom-nav">
							...
							<li class="logo hidden-xs">
								<a href="index.php">
									<img class="logo-gray" src="<?php echo base_url(); ?>assets/images/logo.png" alt="Bloom">
									<img class="logo-black" src="<?php echo base_url(); ?>assets/images/logo-black.png" alt="Bloom">
								</a>
							</li>
